...
export class createEventStageSchedule1602000376369
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "event_stage_schedule" ("id" SERIAL NOT NULL, "title" character varying(255) NOT NULL, "start_date" TIMESTAMP NOT NULL DEFAULT now(), "end_date" TIMESTAMP NOT NULL DEFAULT now(), "eventStageId" integer NOT NULL, CONSTRAINT "PK_69c59bb672834be0f1c3f564943" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
