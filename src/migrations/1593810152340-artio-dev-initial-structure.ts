...
export class artioDevInitialStructure1593810152340 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user_events" ("id" SERIAL NOT NULL, "userId" integer NOT NULL, "eventId" integer NOT NULL, CONSTRAINT "REL_cdc20a262881171de056ae2e5a" UNIQUE ("eventId"), CONSTRAINT "REL_63cb9d79f7be87efc6efc72a6a" UNIQUE ("userId"), CONSTRAINT "PK_e16aa6bf768bd6b1439cec5c718" PRIMARY KEY ("id", "userId", "eventId"))`);
        ...
        await queryRunner.query(`CREATE TABLE "user_events_roles" ("userEventsId" integer NOT NULL, "roleId" integer NOT NULL, "userEventsUserId" integer, "userEventsEventId" integer, CONSTRAINT "REL_adaf3789688c917cf7ab208958" UNIQUE ("roleId"), CONSTRAINT "REL_da0c026865e245b1511a0e8771" UNIQUE ("userEventsId", "userEventsUserId", "userEventsEventId"), CONSTRAINT "PK_565086969e12db53dba478b7897" PRIMARY KEY ("userEventsId", "roleId"))`);
        await queryRunner.query(`CREATE TABLE "user_roles" ("userId" integer NOT NULL, "roleId" integer NOT NULL, CONSTRAINT "REL_472b25323af01488f1f66a06b6" UNIQUE ("userId"), CONSTRAINT "REL_86033897c009fcca8b6505d6be" UNIQUE ("roleId"), CONSTRAINT "PK_88481b0c4ed9ada47e9fdd67475" PRIMARY KEY ("userId", "roleId"))`);
