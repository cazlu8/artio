...
export class usereventsroles1593810152850 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "user_events_roles" ("userEventsId" integer NOT NULL, "roleId" integer NOT NULL, "userEventsUserId" integer, "userEventsEventId" integer, CONSTRAINT "PK_565086969e12db53dba478b7897" PRIMARY KEY ("userEventsId", "roleId"))`,
    );
    await queryRunner.query(
