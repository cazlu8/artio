...
export class createEventStage1601070210517 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "event_stages" ("id" SERIAL NOT NULL, "name" character varying(255), "region" character varying(12), "channel_id" integer NOT NULL, "cdn_distribution_id" character varying(15), "liveUrl" character varying(255), "streamKey" character varying(255), "streamUrl" character varying(255), "onLive" boolean NOT NULL DEFAULT false, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "eventId" integer NOT NULL, CONSTRAINT "REL_51d605e87092fbea14e82d002c" UNIQUE ("eventId"), CONSTRAINT "PK_fb7ed931d2577871c6f0f010cf8" PRIMARY KEY ("id", "eventId"))`,
    );
    await queryRunner.query(
