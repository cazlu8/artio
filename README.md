...
```bash
   ...
   Firebase Auth Service - A microservice to authentication (https://firebase.google.com/products/auth)
   AWS logging - A AWS cloud service to use as API logger (https://cloud.google.com/logging/docs) 
